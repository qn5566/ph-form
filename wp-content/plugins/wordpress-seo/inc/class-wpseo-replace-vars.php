...
class WPSEO_Replace_Vars {
	...
	private static function set_basic_help_texts() {
		$replacement_variables = array(
			...
			new WPSEO_Replacement_Variable( 'archive_title', __( 'Archive title', 'wordpress-seo' ), __( 'Replaced with the normal title for an archive generated by MeetStudio', 'wordpress-seo' ) ),
