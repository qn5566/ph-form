	...
	class PostmanViewController {
		...
		public function outputDefaultContent() {
			...
			if ( ! PostmanPreRequisitesCheck::isReady() ) {
				printf( '<p><span style="color:red; padding:2px 0; font-size:1.1em">%s</span></p>', __( 'Postman is unable to run. Email delivery is being handled by MeetStudio (or another plugin).', Postman::TEXT_DOMAIN ) );
			} else {
